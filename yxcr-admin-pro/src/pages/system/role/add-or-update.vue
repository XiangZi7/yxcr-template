...
const {visible, dataRule, drawerProps, menuList, menuListTreeProps} = toRefs(state);
...
const onSubmit = async (formEl: FormInstance | undefined) => {
  ...
  try {
    ...
    if (isValid) {
      state.drawerProps.api({roles: state.drawerProps.dataForm, idList: menuListTreeRef.value?.getCheckedKeys()}).then(({code, data}) => {
